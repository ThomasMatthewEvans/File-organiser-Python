        ...
        for filename in os.listdir(path):
            ...
            if addFolder =="Y":
                ...
                print Key # Now there are a list of strings, need to get size of each folder
                    Val0= os.path.getsize("C:\\Folder Sorter" +"/" +Key[0]) #hope it would print size of folder a however it does not worlk!!
                        print Val0
                    Val1= os.path.getsize("C:\\Folder Sorter" +"/" +Key[1]) #
                        print Val1
                    Val2= os.path.getsize("C:\\Folder Sorter" +"/" +Key[2]) #
                        print Val2
                    Val3= os.path.getsize("C:\\Folder Sorter" +"/" +Key[3]) #
                        print Val3
